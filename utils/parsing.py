...
def add_common_args(parser):
    ...
    group.add_argument("--data_name", help="Dataset name",choices = ["copolymer_4w"], type=str, default="copolymer_4w")
    ...
    group.add_argument("--exp_no", help="Experiment No", default="")
...
def add_preprocess_args(parser):
    ...
    # data paths
    group.add_argument("--train_path", help="Train source", type=str, default="")
    group.add_argument("--val_path", help="Validation source", type=str, default="")
    group.add_argument("--test_path", help="Test target", type=str, default="")
    # options
...
def add_train_args(parser):
    ...
    group.add_argument("--capacity", help="Decoder embedding size", type=int, default=1)
    group.add_argument("--node_size", help="Decoder embedding size", type=int, default=256)
    group.add_argument("--edge_size", help="Decoder embedding size", type=int, default=256)
    # -------------- mpn encoder ---------------
    group.add_argument("--mpn_type", help="Type of MPN", type=str,
                       choices=["dgcn", "dgat", "dgate", "dgates", "ffn", "polygnn","spherenet"], default="")
